...
- b8b08cc: API changes in support of the new `@eventfabric/mediator` + `@eventfabric/sagas` family. (Linked group — same bump applies to `@eventfabric/postgres` and `@eventfabric/opentelemetry`.)
